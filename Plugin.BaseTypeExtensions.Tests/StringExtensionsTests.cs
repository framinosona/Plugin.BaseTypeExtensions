...
{
    [Fact]
    public void NullIfEmptyOrWhiteSpace_ReturnsNullForWhitespace()
    {
        StringExtensions.NullIfEmptyOrWhiteSpace("   ").Should().BeNull();
    }

    [Fact]
    public void NullIfEmptyOrWhiteSpace_ReturnsOriginalForValue()
    {
        var value = "hello";
        StringExtensions.NullIfEmptyOrWhiteSpace(value).Should().BeSameAs(value);
    }
